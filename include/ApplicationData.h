...
class CApplicationData : public std::enable_shared_from_this<CApplicationData>{
    ...
    friend class CGameLobbyMode;
    friend class CDecorator;
    friend class CChatDecorator;
    friend class CListDecorator;
    ...
    friend class CGameModel;
    friend class CPlayerCapabilityBuildNormal;
	friend class CMapRenderer;
    friend class CAssetDecoratedMap;
    friend class CPlayerCapabilityCancel;
    ...
    protected:
        ...
        typedef enum{
            gstSinglePlayer,
            gstMultiPlayerServer,
            gstMultiPlayerLAN,
            gstMultiPlayerServerHost,
            gstMultiPlayerServerClient,
            gstMultiPlayerLANHost,
            gstMultiPlayerLANClient
        } EGameSessionType, *EGameSessionTypeRef;

        typedef enum{
            gtPrivate,
            gtPublic
        } EGameType, *EGameTypeRef;
        ...
        float DSoundVolume;
        float DMusicVolume;
        std::string DLANUsername;
        std::string DLANPassword;
        std::string DLANIPAddress;
        int DLANPort;

        std::string DServerUsername;
        std::string DServerPassword;
        int DServerPort;
        std::vector<std::string> DUserInfo;

        std::string DGameName;
        std::string DGamePassword;
        ...
        std::shared_ptr<CGraphicSurface> DIconDescriptionSurface;
        std::shared_ptr<CGraphicSurface> DNotificationSurface;
        ...
        int DIconDescriptionXOffset, DIconDescriptionYOffset;
        int DMenuButtonXOffset, DMenuButtonYOffset;
        int DMapSelectListViewXOffset, DMapSelectListViewYOffset;
        int DNotificationXOffset, DNotificationYOffset;
        ...
        std::shared_ptr< CGraphicTileset > DRangerTrackingIcon;
        std::shared_ptr< CGraphicTileset > DPeasantShelterIcon;
        ...
        std::shared_ptr< CGraphicTileset > DTreeTileset;
        ...
        std::shared_ptr< CUnitDescriptionRenderer > DIconDescriptionRenderer;
        std::shared_ptr< CUnitDescriptionRenderer > DNotificationRenderer;
        ...
        std::shared_ptr< CEditRenderer > DChatBoxRenderer;

        //Multiplayer Client
		std::shared_ptr< CMultiplayerClient > DMultiplayerClient;
        ...
        CButtonRenderer::EButtonState DDescriptionState;
        ...
        void LoadGameMap(int index, std::shared_ptr< CDataSource > source);
    ...
    public:
        std::shared_ptr< CGameModel > GetGameModel() const{
            return DGameModel;
        }
