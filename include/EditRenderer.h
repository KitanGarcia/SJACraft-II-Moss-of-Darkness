...
class CEditRenderer{
    ...
    public:        
        ...
        void DrawChatBox(std::shared_ptr< CGraphicSurface > surface, int x, int y, int cursorpos);
        void DrawChatEdit(std::shared_ptr< CGraphicSurface > surface, int x, int y, int cursorpos, int W, int H);
};
