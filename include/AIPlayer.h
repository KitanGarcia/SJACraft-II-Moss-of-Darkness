...
class CAIPlayer{
    ...
    public:
        ...
        static int GetNearestAssetFromOfType(lua_State *L);
        static int GetNearestEnemyLocation(lua_State *L);

        static int GetBestAssetPlacement(lua_State *L);
        static int GetNumberOfGoldMines(lua_State *L);
        ...
        static int GetAssetAction(lua_State *L);
        ...
        static int GetAllPlayerAssetsWithCapability(lua_State *L);
        static int GetAllInteruptablePlayerAssetsWithCapability(lua_State *L);
        ...
        static int GetLocationsOfIdleAssetsOfType(lua_State *L);
        static int GetLocationsOfAssetsOfType(lua_State *L);
        static int GetAllPlayerBuildingAssets(lua_State *L);
        static int GetNearestEnemy(lua_State *L);
        static int GetAssetColor(lua_State *L);
        static int CanInitiate(lua_State *L);
        static int GetCanPlaceAssetOfSize(lua_State *L);
        static int GetLocationsOfAllEnemyTypes(lua_State *L);
        static int GetUpgradeStatus(lua_State *L);
        static int GetBuilder(lua_State *L);
        static int GetTownHallPos(lua_State *L);
        //Lua Command Setters
        ...
        static int SwitchToggle(lua_State *L);
        ...
        void CleanCommand(SPlayerCommandRequest &command);

        bool LoadCommand(SPlayerCommandRequest &command, std::string source);
};
