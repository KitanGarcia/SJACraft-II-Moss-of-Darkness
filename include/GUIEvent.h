...
struct SGUIKeyType{
    ...
    static const uint32_t KeyPad0;
    static const uint32_t KeyPad1;
    static const uint32_t KeyPad2;
    static const uint32_t KeyPad3;
    static const uint32_t KeyPad4;
    static const uint32_t KeyPad5;
    static const uint32_t KeyPad6;
    static const uint32_t KeyPad7;
    static const uint32_t KeyPad8;
    static const uint32_t KeyPad9;
