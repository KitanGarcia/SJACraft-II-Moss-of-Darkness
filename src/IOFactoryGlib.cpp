...
* @class IOFactoryGlib
*
* @brief IOFactoryGlib involves four header files: IOChannel.h, IOEvent.h, IOFactory.h, and IOFactoryGlib.h
...
*
* @return True when DValue & EventIn
*
*/
...
*
* @return True when DValue & EventOut
*
*/
...
*
* @return True when DValue & EventPriority
*
*/
...
*
* @return True when DValue & EventError
*
*/
...
*
* @return True when DValue & EventHangup
*
*/
...
*
* @return True when DValue & EventInvalid
*
*/
...
/**
* Should set the unsigned integer DValue permission to clear and read only
*
* @return void
*
*/
...
/**
* Should set the unsigned integer DValue permission to clear and write only
*
* @return void
*
*/
...
/**
* Should set the unsigned integer DValue permission to clear, read, and write only
*
* @return void
*
*/
...
*
* @return Shared pointer of a new CIOChannel object
*
*/
...
*
* @return True if the callback is InEventCallback
*
*/
...
* @param[in] data gpointer object
*
* @return True if the callback is OutEventCallback
*
*/
...
* @param[in] data gpointer object
*
* @return True if the callback is PriorityEventCallback
*
*/
...
* @param[in] data gpointer object
*
* @return True if the callback is ErrorEventCallback
*
*/
...
* @param[in] data gpointer object
*
* @return True if the callback is HangUpEventCallback
*
*/
...
* @param[in] data gpointer object
*
* @return True if the callback is InvalidEventCallback
*
*/
