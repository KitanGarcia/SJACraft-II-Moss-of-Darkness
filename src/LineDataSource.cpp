...
*
* @brief LineDataSource creates an instance of CLineDataSource which reads a line of text and determines if the line of data is valid
*   
...
*
* @return True if reached a new line character
*
*/
