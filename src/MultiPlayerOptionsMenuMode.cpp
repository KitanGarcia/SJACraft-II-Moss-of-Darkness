...
/**
* Constructor for the CMultiPlayerOptionsMenuMode class.
* 
* @param[in] key An empty struct, used for debugging.
*
*/
...
void CMultiPlayerOptionsMenuMode::HostMultiPlayerButtonCallback(std::shared_ptr< CApplicationData > context){
    if(context->DGameSessionType == CApplicationData::gstMultiPlayerLAN){
        context->DGameSessionType = CApplicationData::gstMultiPlayerLANHost;
    }
    else{
...
void CMultiPlayerOptionsMenuMode::JoinMultiPlayerButtonCallback(std::shared_ptr< CApplicationData > context){
    if(context->DGameSessionType == CApplicationData::gstMultiPlayerLAN){
        context->DGameSessionType = CApplicationData::gstMultiPlayerLANClient;
    }
    else{
        context->DGameSessionType = CApplicationData::gstMultiPlayerServerClient;
    }
