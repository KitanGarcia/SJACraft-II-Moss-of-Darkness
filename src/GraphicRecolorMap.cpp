...
*
* @brief This class handles the coloring all assets that are part of the CGraphicsColorTileset. It Renders all the buildings
*        units, and other assets that are owned by a specific player in the game. It loads all the available colors from the 
*        color.png and then rerenders the default colors to match the mapping in the vector of player colors. 
*
* @author Alex
*
* @version 9.0
