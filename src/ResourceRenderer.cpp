...
*
* @brief This class maintains all resources rendering information
*
* @author Hugo
*
* @version 9.0
...
/**
* @class EMiniIconTypes
*
* @brief An enumerated class for MiniIconTypes
*
*/
...
/**
* A CResourceRenderer object constructor
*
* @param[in] icons The shared pointer to a CGraphicTileset object
* @param[in] font The shared pointer to a CFontTileset object
...
/**
* A CResourceRenderer object destructor
*
*/
...
/**
* A member function that draws player's resources such as gold and lumbers
*
