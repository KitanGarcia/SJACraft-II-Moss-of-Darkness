...
/**
*  If sound level is between 0 and 100 inclusive, return true if the string parameter is equal to the sound level. Else returns false
*
*  @param[in] str string
*
*  @return True if the string parameter is equal to the sound level
*
*/
...
/**
* Changes the mode to OptionsMenuMode
*
* @param[in] context The shared pointer to Application Data
*
* @return void
*
*/
...
/**
* Creates an instance of SoundOptionsMenuMode
*
* @return Shared pointer to CSoundOptionsmode
*
*/
