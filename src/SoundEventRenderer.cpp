...
/**
* A CSoundEventRenderer object constructor, maps sound clips to events
*
* @param[in] mixer The shared pointer to a CSoundLibraryMixer object
* @param[in] player The shared pointer to a CPlayerData object
*
*/
...
CSoundEventRenderer::CSoundEventRenderer(std::shared_ptr< CSoundLibraryMixer > mixer, std::shared_ptr< CPlayerData > player){
    ...
    Names[to_underlying(EAssetType::GoldVein)] = "vein";
...
/**
* RightBias function, compares the position of the viewport rectangle to the cursor position
*
* @param[in] viewportrect The reference of a SRectangle struct
* @param[in] position The reference of a CPosition object
*
* @return A floting point number
*
*/
...
/**
* Checks if the mouse is pointing at the viewport
*
* @param[in] viewportrect The reference of a SRectangle struct
* @param[in] position The reference of a CPosition object
*
* @return True if mouse is pointing at the viewport
*
*/
...
/**
* A function to render all the sound clips
*
* @param[in] viewportrect The reference of a SRectangle struct
* @return void
*
