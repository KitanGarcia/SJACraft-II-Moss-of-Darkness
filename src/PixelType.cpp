...
* param[in] blue Integer, not used
*
*/
...
CPixelType::CPixelType(const CPlayerAsset &asset){
    switch(asset.Type()){
        ...
        case EAssetType::Ranger:        DType = EAssetTerrainType::Ranger;
                                        break;
        case EAssetType::Knight:		DType = EAssetTerrainType::Knight;
        								break;
        ...
        case EAssetType::Wall:          DType = EAssetTerrainType::Wall;
                                        break;
        case EAssetType::GoldVein:      DType = EAssetTerrainType::GoldVein;
                                        break;
        default:                        DType = EAssetTerrainType::None;
                                        break;
    }
...
EAssetType CPixelType::AssetType() const{
    switch(DType){
        ...
        case EAssetTerrainType::Knight:			return EAssetType::Knight;
        ...
        case EAssetTerrainType::GoldVein:       return EAssetType::GoldVein;
