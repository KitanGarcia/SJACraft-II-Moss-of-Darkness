...
*
* @return True if mouse button has been pressed twice.
*
*/
...
*
* @return True if mouse button has been pressed three times.
*
*/
...
*
* @return True if mouse button has been released.
*
*/
...
*
* @return True if val is a currently active modifier.
*
*/
...
//Assigns an unsigned integer to track if the tab button is pressed.
const uint32_t SGUIKeyType::Tab = GDK_KEY_Tab;
...
//Assigns an unsigned integer to track if the '0' key is pressed.
const uint32_t SGUIKeyType::KeyPad0 = GDK_KEY_KP_0;

//Assigns an unsigned integer to track if the '1' key is pressed.
const uint32_t SGUIKeyType::KeyPad1 = GDK_KEY_KP_1;

//Assigns an unsigned integer to track if the '2' key is pressed.
const uint32_t SGUIKeyType::KeyPad2 = GDK_KEY_KP_2;

//Assigns an unsigned integer to track if the '3' key is pressed.
const uint32_t SGUIKeyType::KeyPad3 = GDK_KEY_KP_3;

//Assigns an unsigned integer to track if the '4' key is pressed.
const uint32_t SGUIKeyType::KeyPad4 = GDK_KEY_KP_4;

//Assigns an unsigned integer to track if the '5' key is pressed.
const uint32_t SGUIKeyType::KeyPad5 = GDK_KEY_KP_5;

//Assigns an unsigned integer to track if the '6' key is pressed.
const uint32_t SGUIKeyType::KeyPad6 = GDK_KEY_KP_6;

//Assigns an unsigned integer to track if the '7' key is pressed.
const uint32_t SGUIKeyType::KeyPad7 = GDK_KEY_KP_7;

//Assigns an unsigned integer to track if the '8' key is pressed.
const uint32_t SGUIKeyType::KeyPad8 = GDK_KEY_KP_8;

//Assigns an unsigned integer to track if the '9' key is pressed.
const uint32_t SGUIKeyType::KeyPad9 = GDK_KEY_KP_9;
...
*
* @return True if val is the key currently being looked at.
*
*/
...
*
* @return True if DValue is either an uppercase or lowercase alphabetical character.
*
*/
...
*
* @return True if DValue is either an alphabetical character or a digit.
*
*/
...
*
* @return True if DValue has an ASCII value between 0 and 9.
*
*/

bool SGUIKeyType::IsDigit() const{
    return ((Key0 <= DValue)&&(Key9 >= DValue) || (KeyPad0 <= DValue)&&(KeyPad9 >= DValue));
}

/**
* Checks if the most recent key press is from the numpad.
*
* @return True if DValue has an GDK_KEY value between 0 and 9.
*
*/

bool SGUIKeyType::IsNumPad() const{
    return (KeyPad0 <= DValue)&&(KeyPad9 >= DValue);
}
...
*
* @return True if DValue has an ASCII value between 'A' and 'Z'.
*
*/
...
*
* @return True if DValue has an ASCII value
*
*/
...
*
* @return A shared_ptr with information about the application GUI.
*
*/
...
*
* @return A shared_ptr with the default settings for a GUI display.
*
*/
...
*
* @return A shared_ptr to a new drawing area GUI.
*
*/
...
*
* @return A shared_ptr to a new box GUI.
*
*/
...
*
* @return A shared_ptr to a new menu bar.
*
*/
...
*
* @return A shared_ptr to a new menu item.
*/
...
*
* @return A shared_ptr to a new file filter.
*
*/
...
* parent window.
*
* If openfile is true, the function returns the options to open the file or cancel. If openfile is not true,
* the function returns the options to save the file or cancel.
*
...
*
* @return shared_ptr to a dialogue window, asking whether the user wants to open (or save) a file, or cancel the action.
*
*/
...
/**
* Constructor for the CGUIApplicationGTK3 class.
*
* @param[in] appname A string storing the name of the application.
*
*/
...
/**
*Destructor for the CGUIApplication class.
*
*/
...
*
* @return False if the program isn't timing out.
*
*/
...
*
* @return A shared_ptr to the created window.
*/
...
/**
* Constructor for the CGUIDisplayGTK3 class.
*
* @param[in] A pointer to a GdkDisplay object. 
*
*/
...
/**
* The destructor for the CGUIDisplay class.
*
*/
...
*
* @return A shared ptr to the cursor created.
*
*/
...
/**
* Constructor for the CGUICursorGTK3 class. 
*
* @param[in] cursor A pointer to a GdkCursor object.
*
*/
...
/**
* Destructor for the CGUICursorGTK3 class.
*
*/
...
*
* @return The type of cursor as an enum.
*/
...
/**
* The constructor for the CGUIWidgetGTK3 class.
* 
* @param[in] widget A pointer to a GtkWidget object.
* @param[in] reference A boolean tracking whether the widget being created has a reference to it. 
*
*/
...
/**
* Destructor for the CGUIWidget class.
*
*/
...
* @param[in] data A pointer with information about the current state of the game.
*
* @return False when there is no button press event left to deal with.
*
*/
...
* @param[in] data A pointer with information about the current state of the game.
*
* @return False when there is no button release event left to deal with.
*
*/
...
* @param[in] data A pointer with information about the current state of the game.
*
* @return False when there is no more need to delete the event callback.
*/
...
* @param[in] data A pointer with information about the current state of the game.
*
* @return False when there is no more motion to handle (calls DMotionCallBack).
*/
...
* @param[in] data A pointer with information about the current state of the game.
*
* @return False when there is no more key press to handle (calls DKeyPressCallBack).
*
*/
...
* @param[in] data A pointer with information about the current state of the game.
*
* @return False when there is no more key release to handle (calls DKeyReleaseCallBack).
*
*/
...
* @param[in] data A pointer with information about the current state of the game.
*
* @return False when there is no more callback to expose (calls DExposeCallBack).
*
*/
...
* @param[in] data A pointer with information about the current state of the game.
*
* @return False if the callback data is configured.
*/
...
* @param[in] data A pointer with information about the current state of the game.
*
* @return False if the event is done drawing (calls DDrawCallback).
*
*/
...
*
* @return A shared_ptr to the created grahpics surface.
*
*/
...
*
* @return A shared_ptr to the drawing context given by the current window.
*
*/
...
/**
* Constructor for the CGUIContainerGTK3 class.
*
* @param[in] widget A pointer to a widget object to be placed in the container.
* @param[in] reference A bool that returns true if the widget in the container has a reference.
*
*/
...
/**
* The destructor for the CGUIContainerGTK3 class.
*
*/
...
/**
* Constructor for the CGUILabelGTK3 class. 
*
* @param[in] widget A pointer to a widget object.
* @param[in] reference A bool, returns true if the widget has a reference. 
*
*/
...
/**
* The destructor for the CGUILabelGTK3 class.
*
*/
...
*
* @return The label of the widget as a string.
*
*/
...
/**
* Constructor for the CGUIDrawingAreaGTK3 class. 
*
* @param[in] widget A pointer to a widget object in which the drawing area is being created.
* @param[in] reference A bool, true if the widget has a reference.
*
*/
...
/**
* The destructor for the CGUIDrawingAreaGTK3 class.
*
*/
...
/**
* The constructor for the CGUIBoxGTK3 class.
*
* @param[in] widget A pointer to the widget object in which the box is being generated.
* @param[in] reference A bool, true if the widget has a reference.
*
*/
...
/**
* The destructor for the CGUIBoxGTK3 class.
*
*/
...
/**
* Constructor for the CGUIMenuShellGTK3 class 
*
* @param[in] A pointer to a GtkWidget.
* @param[in] reference A bool, true if the widget is referenced.
*
*/
...
/**
* Destructor for the CGUIMenuShellGTK3 class.
*
*/
...
/**
* Constructor for the CGUIMenuGTK3 class. 
*
* @param[in] widget A pointer to a GtkWidget object.
* @param[in] reference A bool, true if the widget has a reference.
*
...
/**
* Destructor for the CGUIMenuGTK3 class.
*
*/
...
/**
* Constructor for the CGUIMenuBarGTK3 class.
*
* @param[in] widget A pointer to a GtkWidget object.
* @param[in] reference A bool, true if the widget is referenced.
*
...
/**
* Destructor for the CGUIMenuBarGTK3 class.
*
*/
...
/**
* Constructor for the CGUIMenuItemGTK3 class.
*
* @param[in] widget A pointer to a GtkWidget object.
* @param[in] reference A bool, true if the widget is referenced.
*
...
/**
* Destructor for the CGUIMenuItem class.
*
*/
...
*
* @return A shared_ptr to a list of the labels.
*
*/
...
/**
* Constructor for the CGUIWindowGTK3 class.
*
* @param[in] widget A pointer to a GtkWidget object.
* @param[in] reference A bool, true if the widget has a reference.
*
...
/**
* Destructor for the CGUIWindowGTK3 class.
*
*/
...
/**
* Constructor for the CGUIFileFilterGTK3 class.
*
* @param[in] widget A pointer to a GtkFileFilter object.
* @param[in] reference A bool, true if the file filter has a reference.
*
*/
...
/**
* Destructor for the CGUIFileFilterGTK3 class.
*
*/
...
/**
* Constructor for the CGUIFileChooserDialogGTK3 class.
*
* @param[in] widget A pointer to a GtkWidget object.
* @param[in] reference A bool, true if the widget has a reference.
*
...
/**
* Destructor for the CGUIFileChooserDialogGTK3
*
*/
...
*
* @return The name of the file in which the current widget is as a string.
*
*/
...
*
* @return Returns a 0 or 1 depending on whether or not the user chose to cancel the file chooser.
*
*/
