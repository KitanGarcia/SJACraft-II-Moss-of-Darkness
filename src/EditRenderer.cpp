...
*
* @return DText String protected data member of text
*
*/
...
*
* @return DMinimumCharacters Integer protected data member containing minimum amount of characters
*
*/
...
void CEditRenderer::DrawChatBox(std::shared_ptr< CGraphicSurface > surface, int x, int y, int cursorpos){
    // Text("", true);
    // DrawEdit(surface, x, y, -1);
...
void CEditRenderer::DrawChatEdit(std::shared_ptr< CGraphicSurface > surface, int x, int y, int cursorpos, int W, int H){
