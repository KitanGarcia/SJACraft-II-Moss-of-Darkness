...
*
* @brief This class is mainly responsible for loading various asset's tiles via LoadTileset(). It parses the various png 
*        files and indexes the entire strip according to the dat file. Once the tileset is loaded we can use utility functions
*        such as findTile or drawTile to render various tile textures from the vector container it is stored in. 
*
* @author Alex
*
* @version 9.0
...
/**
*   /brief Loads the Tileset from the associated datasource
*   @param[in] source: The dat file associated with a particular tileset
*   @return bool If Parsing of file was succesful
*/
...
/**
*   /brief Draws a particular tile on the source surface
*   @param[in] surface: The source surface on which to draw tile
*   @param[in] xpos : the x pixel position
*   @param[in] ypos : the y pixel position
*   @param[in] tileindex : the index of the tile to be rendered
*/
