...
/**
*
* @class CButtonMenuMode
*
* @brief This class is for the MenuMode Buttons.
*
* This class checks if a button has been clicked
...
/**
* Constructor to initialize DButtonHovered to false
*
*/
...
/**
*  Calculate the values found from the Input function
*
* @param[in] context a shared pointer to Application Data
*
* @return void
...
/**
*  Render the basic button as well as set the sound files for button interaction
*
* @param[in] context a shared pointer to Application Data
*
* @return void
